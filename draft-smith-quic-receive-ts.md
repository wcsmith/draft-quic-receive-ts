...
Each Timestamp Range consists of a Gap indicating the largest packet number in
the Timestamp Range, followed by a list of Timestamp Deltas describing the
receive timestamps for each contiguous packet in the Timestamp Range in
